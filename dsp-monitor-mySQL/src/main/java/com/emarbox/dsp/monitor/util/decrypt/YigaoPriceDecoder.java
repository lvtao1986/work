...
public class YigaoPriceDecoder {

	private static final Logger log = LoggerFactory.getLogger(YigaoPriceDecoder.class);
	private static String keyStr = Config.getString("yigao.public.key");
