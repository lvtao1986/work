...
@Controller("yigaoPPBMonitorAction")
@RequestMapping(value="/yigaoppb")
public class YigaoPPBMonitorAction extends BaseMonitorAction {

	private static final Logger log = LoggerFactory.getLogger(YigaoPPBMonitorAction.class);
	...
	public void impressionMonitor(String info, String c,String guid, String sign,String apid,String dcid,String ct,String rt,String rt2,String pid,String td,String bt,String ut,String gid, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			impressionLog.setSupplier(SupplierInfo.YIGAO_PPB);
			impressionLog.setDcid(dcid);
			impressionLog.setCt(ct);
			impressionLog.setRt(rt);
			impressionLog.setRt2(rt2);
			impressionLog.setPid(pid);
			impressionLog.setTd(td);
	...
	public String clickMonitor(String url, String c,String guid, String info, String sign,String apid,String dcid,String ct,String rt,String rt2,String pid,String td,String bt,String ut,String gid, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			clickLog.setSupplier(SupplierInfo.YIGAO_PPB);
