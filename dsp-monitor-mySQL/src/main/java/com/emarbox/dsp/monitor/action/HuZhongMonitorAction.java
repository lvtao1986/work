...
@Controller("huzhongMonitorAction")
@RequestMapping(value = "/huzhong")
public class HuZhongMonitorAction extends BaseMonitorAction {

	private static final Logger log = LoggerFactory.getLogger(HuZhongMonitorAction.class);
	...
	public void impressionMonitor(String info, String c,String ct,String gid, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String biddingPrice = HuZhongPriceDecoder.decode(c);
			...
			impressionLog.setSupplier(SupplierInfo.HUZHONG_ADX);
