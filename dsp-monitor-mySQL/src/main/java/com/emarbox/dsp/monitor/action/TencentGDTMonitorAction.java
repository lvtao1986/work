...
import com.emarbox.dsp.monitor.util.decrypt.TencentGDTDecrypter;

@Controller("tencentGDTMonitorAction")
@RequestMapping(value = "/tencentGDT")
public class TencentGDTMonitorAction extends BaseMonitorAction {

	private static final Logger log = LoggerFactory.getLogger(TencentGDTMonitorAction.class);

	/**
	 * 兼容广点通agent为空用的agent字符串
	 */
	private static final String FIX_AGENT_STR = "fix tencent gdt no agent str";
	...
	public void impressionMonitor(String info, String c,String gid, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String biddingPrice = TencentGDTDecrypter.DecodePrice(c);
			...
			impressionLog.setActionType("impression");
			...
			impressionLog.setSupplier(5050);
	...
	public String clickMonitor(String url, String c, String gid,String info, HttpServletRequest request, HttpServletResponse response) {
