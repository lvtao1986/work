...
@Controller("taobaoMonitorAction")
@RequestMapping(value="/taobao")
public class TaobaoMonitorAction extends BaseMonitorAction {

	private static final Logger log = LoggerFactory.getLogger(TaobaoMonitorAction.class);
	private static final Logger exposureLog = LoggerFactory.getLogger("exposure");
	...
	public void impressionMonitor(String info, String c,String guid, String sign,String apid,String dcid,String ct,String rt,String rt2,String bt,String ut,String gid, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			impressionLog.setSupplier(SupplierInfo.TAOBAO_TANX);
	...
	public void exposure(String info, String c,String guid, String sign,String apid,String dcid,String ct,String rt,String rt2, HttpServletRequest request, HttpServletResponse response) {
			exposureLog.info(info); //记录日志
	}
	...
	public String clickMonitor(String url, String c,String guid, String info, String sign,String apid,String dcid,String ct,String rt,String rt2,String bt,String ut,String gid, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			clickLog.setSupplier(SupplierInfo.TAOBAO_TANX);
