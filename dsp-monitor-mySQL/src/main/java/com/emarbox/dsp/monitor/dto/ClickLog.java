...
public class ClickLog {
	...
	public String toString() {
		return "ClickLog [info=" + info + ", sign=" + sign + ", c=" + c
				+ ", guid=" + guid + ", apid=" + apid + ", actionType="
				+ actionType + ", userId=" + userId + ", ip=" + ip + ", agent="
				+ agent + ", referer=" + referer + ", ct=" + ct + ", rt=" + rt
				+ ", rt2=" + rt2 + ", pid=" + pid + ", td=" + td + ", bt=" + bt + ", ut=" + ut 
				+ ", campaignId=" + campaignId + ", creativeId=" + creativeId
				+ ", adUserId=" + adUserId + ", projectId=" + projectId
				+ ", biddingId=" + biddingId + ", time=" + time
				...
				+ ", getInfo()=" + getInfo() + ", getSign()=" + getSign()
				+ ", getC()=" + getC() + ", getGuid()=" + getGuid()
				+ ", getApid()=" + getApid() + ", getActionType()="
				+ getActionType() + ", getUserId()=" + getUserId()
				+ ", getIp()=" + getIp() + ", getAgent()=" + getAgent()
				+ ", getReferer()=" + getReferer() + ", getUserPrice()="
				+ getUserPrice() + ", getProxyIp()=" + getProxyIp()
				+ ", getRealIp()=" + getRealIp() + ", toString()="
				+ super.toString() + "]";
	}
