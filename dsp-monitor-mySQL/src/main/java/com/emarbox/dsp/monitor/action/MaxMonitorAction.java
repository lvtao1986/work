...
import com.emarbox.dsp.monitor.util.decrypt.HuZhongPriceDecoder;
import com.emarbox.dsp.monitor.util.decrypt.MaxPriceDecoder;
import com.emarbox.dsp.monitor.util.IpUtil;
import com.emarbox.dsp.monitor.util.XXTEA;

@Controller("maxMonitorAction")
@RequestMapping(value = "/mediav")
public class MaxMonitorAction extends BaseMonitorAction {

	private static final Logger log = LoggerFactory.getLogger(MaxMonitorAction.class);
	...
	public void impressionMonitor(String info, String c,String ct,String gid, HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			String biddingPrice = MaxPriceDecoder.decode(c.replace(" ", "+"));
			...
			impressionLog.setSupplier(SupplierInfo.MAX_ADX);
